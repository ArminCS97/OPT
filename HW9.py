...
def barrier_method(c):
    ...
    # for i in range(1, 25):
        ...
        for i in range(4):
                ...
                a0 = minimize_scalar(steepest_descent).x
                # minimize the steepest descent function to
...
def q(x):  # the function q(x1, x2, c)
    return e ** (x[0] ** 2 + x[1] ** 2) - (1 / 100000000) * (1 / (x[0] + x[1] + 4))


b = minimize(q, x0=np.array([0, -1]))
# print(b.x)

barrier_method(9999999999999999999999999999999999999)